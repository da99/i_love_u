...
(function() {
  ...
  Line = (function() {
    ...
    Line.read_able("origin_line", "origin_block", "calling_env");

    Line.read_write_able("line", "block");

    function Line(line_and_block, env) {
      var block, line;
      if (!env) {
      ...
      this.rw("calling_env", env);
      this.line(this.origin_line());
      this.block(this.origin_block());
    }

    Line.prototype.is_a_line = function() {
      return true;
    };
