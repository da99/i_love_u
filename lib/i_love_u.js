...
(function() {
  ...
  exports.i_love_u = i_love_u = (function() {
    ...
    _ref = ['is_read_local', 'is_write_local', 'has_outside'];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      m = _ref[_i];
      i_love_u.prototype[m] = new Function("return this.envs()." + m + "();");
    }
    ...
    i_love_u.prototype.run_line_tokens = function(pair) {
      return this.vars().run_line_tokens(pair);
    };
