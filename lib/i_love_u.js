...
(function() {
  ...
  exports.Args = Args = (function() {
    ...
    Args.read_write_able("types", "regexp");

    function Args(raw_str) {
      var str, t, v, _i, _len, _ref;
    ...
    Args.prototype.sentence_match = function(sent) {
      var caps;
      caps = RegExp.captures(this.regexp(), sent);
  ...
  exports.Procedure = Procedure = (function() {
    ...
    function Procedure(pattern) {
      ...
      this.d().regexp = args_meta.regexp();
    }
