...
(function() {
  var Arguments_Match, LOOP_LIMIT, Line, Procedure, Var, XRegExp, a_new_noun, arr_surgeon, as_num, boolean_type_cast, catch_err, clone_list, cloneextend, compare, comparison_type_cast, derive_list, else_false, englishy, equals, funcy_perm, humane_list, i_love_u, if_true, insert_into_list, is_boolean_string, list_noun, md_num, not_equals, prop_of_noun, run_comparison_on_match, rw, string_da99, to_noun, top_bottom, update_word, while_loop, word_is_word, _, _do_,
    __slice = [].slice;
  ...
  prop_of_noun.write('procedure', function(match) {
