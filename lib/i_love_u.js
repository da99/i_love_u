...
(function() {
  var Procedure, as_num, englishy, i_love_u, md_num, parser, rw, word_is_word,
    __slice = [].slice,
  ...
  exports.Procedure = Procedure = (function() {
    ...
    Procedure.read_write_able('priority', 'pattern', 'regexp', 'data', 'list', 'procedure');

    Procedure.prototype.word_reg = new RegExp("!>WORD<", 'g');

    Procedure.prototype.num_reg = new RegExp("!>NUM<", 'g');

    Procedure.prototype.char_reg = new RegExp("!>CHAR<", 'g');

    Procedure.prototype.chars_reg = new RegExp("!>CHARS<", 'g');
    ...
    function Procedure(pattern) {
      ...
      str = str.replace(this.char_reg, "([^\s])");
      str = str.replace(this.chars_reg, "([^\s])+");
