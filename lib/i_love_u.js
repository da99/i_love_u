...
(function() {
  ...
  exports.i_love_u = i_love_u = (function() {
    ...
    i_love_u.prototype.run_tokens = function(line, code_block) {
      var compiled, current, matched, matched_to_proc, me, orig_pair, proc, the_same, _i, _len, _ref;
      ...
      the_same = orig_pair.length === compiled.length && _.isEqual(orig_pair, compiled);
      return the_same;
    };

    i_love_u.prototype.run = function() {
      var end, i, line_and_block, lines, the_same, _i, _len;
      lines = (new englishy.Englishy(this.code())).to_tokens();
      for (i = _i = 0, _len = lines.length; _i < _len; i = ++_i) {
        line_and_block = lines[i];
        the_same = this.run_tokens(line_and_block[0], line_and_block[1]);
        if (the_same) {
