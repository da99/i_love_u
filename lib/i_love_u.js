...
(function() {
  var Procedure, Var, arr_surgeon, as_num, else_false, englishy, funcy_perm, i_love_u, if_false, if_true, md_num, rw, string_da99, word_is_word, _,
    __slice = [].slice;
  ...
  exports.Var = Var = (function() {
    ...
    Var.read_able("name", "value", "inherits_from");
  ...
  exports.i_love_u = i_love_u = (function() {
    ...
    i_love_u.prototype.run = function() {
      var code_block, compiled, current, end, i, line, line_and_block, lines, matched, matched_to_proc, me, orig_pair, proc, _i, _j, _len, _len1, _ref, _ref1;
      ...
      for (i = _i = 0, _len = lines.length; _i < _len; i = ++_i) {
        ...
        if (orig_pair.length === compiled.length && _.isEqual(orig_pair, compiled)) {
          end = code_block ? ":" : ".";
