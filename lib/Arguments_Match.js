...
(function() {
  ...
  Arguments_Match = (function() {
    ...
    Arguments_Match.permutate = function(env, line) {
      var block, clone, data_pos, group, i, ind, line_arr, perms, raw_perms, str, _i, _j, _len, _len1;
      line_arr = line.line();
      block = line.block();
      data_pos = (function() {
    ...
    function Arguments_Match(arg_list, env, line, proc) {
      var a, a_i, args, combo, desc_slice, f, final_line_arr, finders, i, l, limit, list, perms, pi, print_it, result, _i, _j, _len, _len1, _ref;
      ...
      for (a_i = _i = 0, _len = _ref.length; _i < _len; a_i = ++_i) {
        ...
        finders.push(function(v, i, fi) {
          ...
          if (extracted.length) {
            args.splice.apply(args, [args.length, 0].concat(__slice.call(extracted)));
          }
          return true;
        });
