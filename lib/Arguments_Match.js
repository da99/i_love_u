...
(function() {
  ...
  Arguments_Match = (function() {
    ...
    function Arguments_Match(arg_list, env, line_n_code, proc) {
      var a, a_i, code, combo, desc_slice, f, final_line_arr, finders, i, l, limit, line, list, perms, pi, print_it, _i, _j, _len, _len1, _ref;
      line = line_n_code[0];
      code = line_n_code[1];
      ...
      perms = proc.priority() === "before_variables" ? [line] : this.constructor.permutate(env, line, code);
      list = this.list();
      finders = [];
      print_it = false;
      _ref = this.list();
