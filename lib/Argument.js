...
(function() {
  ...
  Argument = (function() {
    ...
    Argument.type_names = ['WORD', 'NUM', 'CHAR', 'ANY', 'true', 'true_or_false', 'false'];
    ...
    Argument.ANY = {
      ...
      regexp_string: function() {
        var _base, _ref;
        return (_ref = (_base = this.d).reg_str) != null ? _ref : _base.reg_str = "([^\\s]+)";
      },
    ...
    Argument["true"] = {
      ...
      regexp_string: function() {
        var _base, _ref;
        return (_ref = (_base = this.d).reg_str) != null ? _ref : _base.reg_str = "(true)";
      },
      is_a_match_with: function(unk) {
        return ("" + unk) === "true";
      },
    ...
    Argument["false"] = {
      ...
      regexp_string: function() {
        var _base, _ref;
        return (_ref = (_base = this.d).reg_str) != null ? _ref : _base.reg_str = "(false)";
      },
      is_a_match_with: function(unk) {
        return ("" + unk) === "false";
      },
    ...
    Argument.true_or_false = {
      ...
      regexp_string: function() {
        var _base, _ref;
        return (_ref = (_base = this.d).reg_str) != null ? _ref : _base.reg_str = "(true|false)";
      },
      is_a_match_with: function(unk) {
